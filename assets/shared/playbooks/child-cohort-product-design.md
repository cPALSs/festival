---
status: stub
title: Child Cohort Product Design
asset_type: playbook
season: cross
related_seasons: [lny, autumn]
---

> **Index** — child audience design split into topic pages. Edit the matching file under `docs/child-audience/` (published on GitHub Pages with TOC layout).
...
- **Source of truth for content:** `docs/child-audience/*.md` — agents and humans edit there.
- This index file only — do not grow a second full copy here.
- Narrative walkthroughs live under `docs/child-audience/walkthroughs/`.

## Related assets

| Asset | Path |
|-------|------|
| Principles P2 (group attendance) | `docs/principles.md` |
| Autumn home base spec | `assets/autumn/group-activities/home-base-station-spec.md` (stub) |
| Case study — MAF pilot | `assets/case-studies/maf-2026-pilot.md` |

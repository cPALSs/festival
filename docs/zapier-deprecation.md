...
The **Zoom → Notion** Zap (and any related CSV export to `Operations/Board Desk/`) is **disabled**. Meeting summaries are retrieved on demand via **Zoom Workspace MCP**.
...
4. If a separate Zap exports meeting notes to CSV (`Governance/Board/Retreats/2026-03-21/2026 Eric Lofholm running meeting notes.csv`), disable that too unless you still want CSV backups.

## After disabling

- New meetings will **not** appear in Notion Meeting Notes.
- Historical Notion pages remain until you cancel Notion; substantive ops content was migrated to coalition-internal project season folders and `Operations/Board Desk/` markdown.

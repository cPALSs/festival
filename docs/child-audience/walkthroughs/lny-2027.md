...
|------|------------------|
| **11:00** | Gates open. Village and shade paths ready. |
| **11:30** | Lion dance on main stage — loud; quiet rest available in the village. |
| **12:00** | First children’s show in the theater pocket. |
| **12:30** | Roam, crafts, club home bases open. |
| **1:00** | **Parade** (~45 min) — relay teams introduced; heats are Sunday. |
...
**11:00 — Arrive on the shade path.** Enter through the village, not the food row. Slow-moving décor at stroller height gives a visual win before any line.

**11:30 — Lion dance (optional).** Watch from the quiet buffer or skip entirely. No guilt — heritage will repeat on Sunday.

**12:00–12:30 — Sensory table while siblings see a show.** A low-volume touch table in the village while an older child catches the theater set nearby. You sit in shade.
...
**The first twenty minutes decide the day.** A toddler who doesn’t get a quick win — a character, bubbles, or a photo moment — can veto the whole outing. Plan arrival for 11:00, not 1:00.

**Where to be:** Bounded village corral, short roving character loops, theater pocket with an obvious exit door. Avoid long seated shows and bounce houses with no shade next door.

### How the morning might go

**11:00–11:20 — The veto window.** Roving zodiac character, bubble mat, or backdrop photo — something must land before 11:20.

**11:30 — Story theater (15–20 min).** Activator reads; character enacts; parents ring the blanket. Early exit is always OK.

**12:30 — Parallel play.** Duplicate craft stations (short lines), touch-a-truck with engines off, stroller parking in sight.
...
<li>C1 lead owns corral radio for the 11:00 window</li>
...
**11:15 — Short character meet** (about 10 min) with a hero or zodiac hook.

**12:00 — Children’s show** — full first set; parent-and-child delight, not solo drop-off.

**12:30 — Craft → take-home prop.** Lantern panel or zodiac mask.
...
**11:00 — Optional scavenger stamp card** while the family finds its bearings.

**12:00 — Children’s show** — same theater pocket; tolerates enactment and mild challenge callbacks.

**12:30 — Home base opens.** Club pin, PTA banner, *find your tribe* board. Example on the grid: *Eastside Martial · 12:45 @ Challenge row*.
...
|------|------------------|
| **11:00–12:30** | Both parents at village — baby in shade, toddler at theater |
...
**Sensory-sensitive (SN-A):** Quiet rest buffer in the village; fixed times on the public schedule; loud warnings on lion-dance blocks. Consider a **soft-sensory hour 11:00–12:00** before the noon show — resolve conflict with 11:30 lion by publishing two entry paths (*quiet village* vs *heritage viewing*).
...
| **Toddler & preschool** | First show time · character name · *early exit OK* |
